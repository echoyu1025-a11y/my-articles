...
> [!NOTE]
> 本文是一篇面向新手的 `Stable Diffusion` 入门教程。先横向对比 Midjourney、SD、DALL·E 3 三款主流 AI 绘画工具的定位差异，随后聚焦可控性最高的 SD：从配置要求与秋叶整合包安装、启动器各面板讲起，再系统梳理 Webui 界面的模型区（大模型、Lora、Embedding、VAE 等五类模型）、提示词区（书写思路与六大基本语法）、参数设置（采样方法、迭代步数、高分辨率修复、CFG、种子等）以及图生图、局部重绘、批量处理等功能，帮你建立对 SD 使用的全局认知。

## 目录

- [前言](#前言)
- [一、市面上三款主流绘画软件对比](#一市面上三款主流绘画软件对比)
- [二、Stable diffusion的介绍](#二stable-diffusion的介绍)
- [三、SD的配置要求及安装](#三sd的配置要求及安装)
- [四、启动器介绍](#四启动器介绍)
- [五、Webui界面介绍](#五webui界面介绍)
- [六、写在最后](#六写在最后)
