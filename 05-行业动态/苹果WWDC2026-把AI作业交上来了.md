...
> [!NOTE]
> 一句话总结：这是 Tim Cook 任内最后一届 WWDC，苹果没有把重点放在硬件，而是围绕 `iOS 27` 系统提速、搜索基础设施重做、儿童安全、以及与 Google 合作的 `Apple Intelligence` 新架构，把 Siri 升级为系统级的 `Siri AI`，并让 AI 全面渗入 Safari、Passwords、Calendar、Home、Shortcuts、照片编辑和开发者工具，交出了它过去几年最慢那块能力的答卷。

## 目录

- [一、系统体验：iPhone、iPad、Mac 都在变快](#一系统体验iphoneipadmac-都在变快)
- [二、网络与消息：少一点手动切 Wi-Fi，多一点发送进度提示](#二网络与消息少一点手动切-wi-fi多一点发送进度提示)
- [三、搜索：Spotlight、照片、邮件的底层索引重做了](#三搜索spotlight照片邮件的底层索引重做了)
- [五、儿童安全：儿童账号、内容限制、联系人、时间管理全部重做](#五儿童安全儿童账号内容限制联系人时间管理全部重做)
- [七、Siri AI：新版 Siri 变成系统级 AI 助手](#七siri-ai新版-siri-变成系统级-ai-助手)
- [十、写作工具：随处写、改、润色，还能模仿你和某个人说话的风格](#十写作工具随处写改润色还能模仿你和某个人说话的风格)
- [十一、Safari：自动整理标签页、监控网页、还能生成个人扩展](#十一safari自动整理标签页监控网页还能生成个人扩展)
- [十三、Home：通知合并、摄像头视频总结、4K 录像](#十三home通知合并摄像头视频总结4k-录像)
- [十四、Shortcuts：用一句话生成自动化](#十四shortcuts用一句话生成自动化)
- [十五、Image Playground：图片生成质量升级，可用自然语言改图](#十五image-playground图片生成质量升级可用自然语言改图)
- [十六、照片编辑：消除、扩图、空间重构三件套](#十六照片编辑消除扩图空间重构三件套)
- [十七、可用性与限制：Siri AI 先英语，部分地区暂不上线](#十七可用性与限制siri-ai-先英语部分地区暂不上线)
- [十九、发布时间：开发者 beta、公开 beta、正式版](#十九发布时间开发者-beta公开-beta正式版)
- [写在最后](#写在最后)
...
![图1](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/01.png)
...
![图2](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/02.png)
...
![图3](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/03.png)
...
![图4](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/04.png)
...
![图5](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/05.png)
...
![图6](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/06.png)
...
![图7](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/07.png)
...
![图8](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/08.png)
...
![图9](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/09.png)
...
![图10](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/10.png)
...
![图11](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/11.png)
...
![图12](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/12.png)
...
![图13](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/13.png)
...
![图14](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/14.png)
...
![图15](../引用的图片/05-行业动态/苹果WWDC2026-把AI作业交上来了/15.png)
